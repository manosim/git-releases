...
},{"./src":170}],158:[function(require,module,exports){
'use strict';
...
},{"./joins":171,"./utils":175}],162:[function(require,module,exports){
var _ = require('./utils'),
...
},{"./ListenerMethods":161,"./utils":175}],163:[function(require,module,exports){
var _ = require('./utils');
...
},{"./utils":175}],164:[function(require,module,exports){
/**
...
},{"./ListenerMethods":161,"./ListenerMixin":162,"./utils":175}],167:[function(require,module,exports){
var ListenerMethods = require('./ListenerMethods'),
    ListenerMixin = require('./ListenerMixin'),
    _ = require('./utils');
...
},{"./ListenerMethods":161,"./ListenerMixin":162,"./utils":175}],168:[function(require,module,exports){
var _ = require('./utils'),
...
},{"./ActionMethods":159,"./Keep":160,"./PublisherMethods":163,"./utils":175}],169:[function(require,module,exports){
var _ = require('./utils'),
    Keep = require('./Keep'),
    mixer = require('./mixer'),
    allowed = {preEmit:1,shouldEmit:1},
...
},{"./Keep":160,"./ListenerMethods":161,"./PublisherMethods":163,"./StoreMethods":164,"./bindMethods":165,"./mixer":174,"./utils":175}],170:[function(require,module,exports){
...
},{"./ActionMethods":159,"./Keep":160,"./ListenerMethods":161,"./ListenerMixin":162,"./PublisherMethods":163,"./StoreMethods":164,"./connect":166,"./connectFilter":167,"./createAction":168,"./createStore":169,"./joins":171,"./listenTo":172,"./listenToMany":173,"./utils":175}],171:[function(require,module,exports){
/**
...
},{"./createStore":169,"./utils":175}],172:[function(require,module,exports){
var ListenerMethods = require('./ListenerMethods');
...
},{"./ListenerMethods":161}],173:[function(require,module,exports){
var ListenerMethods = require('./ListenerMethods');
...
},{"./ListenerMethods":161}],174:[function(require,module,exports){
var _ = require('./utils');
...
},{"eventemitter3":158}],176:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"emitter":177,"reduce":178}],177:[function(require,module,exports){
...
},{"reflux":157}],181:[function(require,module,exports){
'use strict';
...
var App = React.createClass({
  ...
  render: function render() {
    return React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'container-fluid jumbotron header' },
        React.createElement(
          'h1',
          { className: 'logo' },
          'Git Releases'
...
},{"./components/results":183,"./components/search-form":184,"react":156}],182:[function(require,module,exports){
'use strict';
  ...
  render: function render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        this.props.details.prerelease ? React.createElement(
          'span',
...
},{"../actions/actions":180,"../components/release.js":182,"../stores/repository":185,"react":156,"reflux":157,"underscore":179}],183:[function(require,module,exports){
'use strict';
...
var Results = React.createClass({
  ...
  render: function render() {
    ...
    if (this.state.releases) {
      releases = _.map(this.state.releases, function (obj) {
        return React.createElement(Release, { details: obj, key: obj.id });
      });
    }
...
},{"../actions/actions":180,"../components/release.js":182,"../stores/repository":185,"react":156,"reflux":157,"underscore":179}],184:[function(require,module,exports){
'use strict';
  ...
  render: function render() {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'col-md-offset-6 col-md-4 text-right' },
          React.createElement(
            'a',
            { href: '#', className: 'demo-link', onClick: this.doDemo },
            'or do the demo?'
          )
        )
      )
...
},{"../actions/actions":180,"../stores/repository":185,"react":156}],185:[function(require,module,exports){
'use strict';
...
var RepositoryStore = Reflux.createStore({
  ...
  onGetReleasesCompleted: function onGetReleasesCompleted(releases) {
    this._releases = releases;
    this.trigger(this._releases);
  },

  onGetReleasesFailed: function onGetReleasesFailed() {
    this._releases = [];
    this.trigger(this._releases);
  }
...
},{"../actions/actions":180,"../utils/api-requests":186,"reflux":157}],186:[function(require,module,exports){
'use strict';
...
var apiRequests = {
  get: function get(url) {
    return request.get(url).set('Accept', 'application/vnd.github.v3+json').set('User-Agent', 'GitReleases.com');
  }
};
